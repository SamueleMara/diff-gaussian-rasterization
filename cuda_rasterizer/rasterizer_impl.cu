...
{
    // --- Step 1: Allocate geometry, image, and binning states ---
    ...
    if (!radii) radii = geomState.internal_radii;
    ...
    // --- Step 3: Compute prefix sums & binning ---
    ...
    // --- Step 4: Call render with top-K outputs ---
    CHECK_CUDA(FORWARD::render(
        tile_grid, block,
        imgState.ranges,
        binningState.point_list,
